...
pub struct TaskSpecPlacementPreferences {
    #[serde(rename = "Spread")]
    spread: Option<super::TaskSpecPlacementSpread>,
}
...
impl TaskSpecPlacementPreferences {
    ...
    pub fn set_spread(&mut self, spread: super::TaskSpecPlacementSpread) {
        self.spread = Some(spread);
    }

    pub fn with_spread(
        mut self,
        spread: super::TaskSpecPlacementSpread,
    ) -> TaskSpecPlacementPreferences {
        self.spread = Some(spread);
        self
    }

    pub fn spread(&self) -> Option<&super::TaskSpecPlacementSpread> {
        self.spread.as_ref()
    }
