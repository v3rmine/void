...
impl SystemVersionComponents {
    ...
    pub fn with_name(mut self, name: String) -> SystemVersionComponents {
        self.name = name;
        self
    }
    ...
    pub fn with_version(mut self, version: String) -> SystemVersionComponents {
        self.version = version;
        self
    }
    ...
    pub fn with_details(mut self, details: Value) -> SystemVersionComponents {
        self.details = Some(details);
        self
    }
