...
pub struct ServiceSpecMode {
    ...
    replicated: Option<super::ServiceSpecModeReplicated>,
    #[serde(rename = "Global")]
    global: Option<Value>,
}
...
impl ServiceSpecMode {
    ...
    pub fn set_replicated(&mut self, replicated: super::ServiceSpecModeReplicated) {
        self.replicated = Some(replicated);
    }

    pub fn with_replicated(
        mut self,
        replicated: super::ServiceSpecModeReplicated,
    ) -> ServiceSpecMode {
        self.replicated = Some(replicated);
        self
    }

    pub fn replicated(&self) -> Option<&super::ServiceSpecModeReplicated> {
