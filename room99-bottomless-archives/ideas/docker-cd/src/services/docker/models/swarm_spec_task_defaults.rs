...
pub struct SwarmSpecTaskDefaults {
    ...
    log_driver: Option<super::SwarmSpecTaskDefaultsLogDriver>,
}
...
impl SwarmSpecTaskDefaults {
    ...
    pub fn set_log_driver(&mut self, log_driver: super::SwarmSpecTaskDefaultsLogDriver) {
        self.log_driver = Some(log_driver);
    }

    pub fn with_log_driver(
        mut self,
        log_driver: super::SwarmSpecTaskDefaultsLogDriver,
    ) -> SwarmSpecTaskDefaults {
        self.log_driver = Some(log_driver);
        self
    }

    pub fn log_driver(&self) -> Option<&super::SwarmSpecTaskDefaultsLogDriver> {
