...
pub struct Network {
    ...
    containers: Option<::std::collections::HashMap<String, super::NetworkContainer>>,
...
impl Network {
    ...
    pub fn with_IPAM(mut self, IPAM: super::Ipam) -> Network {
        self.IPAM = Some(IPAM);
        self
    }
    ...
    pub fn set_containers(
        &mut self,
        containers: ::std::collections::HashMap<String, super::NetworkContainer>,
    ) {
    ...
    pub fn containers(
        &self,
    ) -> Option<&::std::collections::HashMap<String, super::NetworkContainer>> {
