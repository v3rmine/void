...
impl Resources {
    ...
    pub fn with_devices(mut self, devices: Vec<super::DeviceMapping>) -> Resources {
        self.devices = Some(devices);
        self
    }
    ...
    pub fn with_device_requests(mut self, device_requests: Vec<super::DeviceRequest>) -> Resources {
        self.device_requests = Some(device_requests);
        self
    }
    ...
    pub fn with_kernel_memory_tcp(mut self, kernel_memory_tcp: i64) -> Resources {
        self.kernel_memory_tcp = Some(kernel_memory_tcp);
        self
    }
    ...
    pub fn with_ulimits(mut self, ulimits: Vec<super::ResourcesUlimits>) -> Resources {
        self.ulimits = Some(ulimits);
        self
    }
