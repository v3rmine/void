...
impl Secret {
    ...
    pub fn with_version(mut self, version: super::ObjectVersion) -> Secret {
        self.version = Some(version);
        self
    }
    ...
    pub fn set_spec(&mut self, spec: super::SecretSpec) {
        self.spec = Some(spec);
    }

    pub fn with_spec(mut self, spec: super::SecretSpec) -> Secret {
        self.spec = Some(spec);
        self
    }

    pub fn spec(&self) -> Option<&super::SecretSpec> {
        self.spec.as_ref()
    }
