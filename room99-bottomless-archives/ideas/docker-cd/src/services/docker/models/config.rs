...
impl Config {
    ...
    pub fn with_version(mut self, version: super::ObjectVersion) -> Config {
        self.version = Some(version);
        self
    }
    ...
    pub fn set_spec(&mut self, spec: super::ConfigSpec) {
        self.spec = Some(spec);
    }

    pub fn with_spec(mut self, spec: super::ConfigSpec) -> Config {
        self.spec = Some(spec);
        self
    }

    pub fn spec(&self) -> Option<&super::ConfigSpec> {
        self.spec.as_ref()
    }
