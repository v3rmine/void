...
pub struct ImagePruneResponse {
    ...
    images_deleted: Option<Vec<super::ImageDeleteResponseItem>>,
...
impl ImagePruneResponse {
    ...
    pub fn set_images_deleted(&mut self, images_deleted: Vec<super::ImageDeleteResponseItem>) {
        self.images_deleted = Some(images_deleted);
    }

    pub fn with_images_deleted(
        mut self,
        images_deleted: Vec<super::ImageDeleteResponseItem>,
    ) -> ImagePruneResponse {
        self.images_deleted = Some(images_deleted);
        self
    }

    pub fn images_deleted(&self) -> Option<&Vec<super::ImageDeleteResponseItem>> {
