...
impl Plugin {
    ...
    pub fn set_settings(&mut self, settings: super::PluginSettings) {
        self.settings = settings;
    }

    pub fn with_settings(mut self, settings: super::PluginSettings) -> Plugin {
        self.settings = settings;
        self
    }

    pub fn settings(&self) -> &super::PluginSettings {
        &self.settings
    }
    ...
    pub fn set_config(&mut self, config: super::PluginConfig) {
        self.config = config;
    }

    pub fn with_config(mut self, config: super::PluginConfig) -> Plugin {
        self.config = config;
        self
    }

    pub fn config(&self) -> &super::PluginConfig {
        &self.config
    }
}
