...
pub struct TaskSpecContainerSpecPrivileges {
    ...
    credential_spec: Option<super::TaskSpecContainerSpecPrivilegesCredentialSpec>,
    #[serde(rename = "SELinuxContext")]
    se_linux_context: Option<super::TaskSpecContainerSpecPrivilegesSeLinuxContext>,
}
...
impl TaskSpecContainerSpecPrivileges {
    ...
    pub fn set_credential_spec(
        &mut self,
        credential_spec: super::TaskSpecContainerSpecPrivilegesCredentialSpec,
    ) {
    ...
    pub fn credential_spec(&self) -> Option<&super::TaskSpecContainerSpecPrivilegesCredentialSpec> {
    ...
    pub fn set_se_linux_context(
        &mut self,
        se_linux_context: super::TaskSpecContainerSpecPrivilegesSeLinuxContext,
    ) {
    ...
    pub fn se_linux_context(
        &self,
    ) -> Option<&super::TaskSpecContainerSpecPrivilegesSeLinuxContext> {
