...
impl NodeStatus {
    ...
    pub fn set_state(&mut self, state: super::NodeState) {
        self.state = Some(state);
    }

    pub fn with_state(mut self, state: super::NodeState) -> NodeStatus {
        self.state = Some(state);
        self
    }

    pub fn state(&self) -> Option<&super::NodeState> {
        self.state.as_ref()
    }
