...
pub struct TaskSpecPluginSpec {
    ...
    plugin_privilege: Option<Vec<super::Body>>,
}
...
impl TaskSpecPluginSpec {
    ...
    pub fn set_plugin_privilege(&mut self, plugin_privilege: Vec<super::Body>) {
        self.plugin_privilege = Some(plugin_privilege);
    }

    pub fn with_plugin_privilege(
        mut self,
        plugin_privilege: Vec<super::Body>,
    ) -> TaskSpecPluginSpec {
        self.plugin_privilege = Some(plugin_privilege);
        self
    }

    pub fn plugin_privilege(&self) -> Option<&Vec<super::Body>> {
