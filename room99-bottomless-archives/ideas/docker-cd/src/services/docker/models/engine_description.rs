...
pub struct EngineDescription {
    ...
    plugins: Option<Vec<super::EngineDescriptionPlugins>>,
}
...
impl EngineDescription {
    ...
    pub fn set_plugins(&mut self, plugins: Vec<super::EngineDescriptionPlugins>) {
        self.plugins = Some(plugins);
    }

    pub fn with_plugins(
        mut self,
        plugins: Vec<super::EngineDescriptionPlugins>,
    ) -> EngineDescription {
        self.plugins = Some(plugins);
        self
    }

    pub fn plugins(&self) -> Option<&Vec<super::EngineDescriptionPlugins>> {
        self.plugins.as_ref()
    }
