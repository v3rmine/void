...
pub struct NetworkSettings {
    ...
    #[serde(rename = "Ports")]
    ports: Option<super::PortMap>,
    /// SandboxKey identifies the sandbox
    #[serde(rename = "SandboxKey")]
    sandbox_key: Option<String>,
    ///
    #[serde(rename = "SecondaryIPAddresses")]
    secondary_ip_addresses: Option<Vec<super::Address>>,
    ///
    #[serde(rename = "SecondaryIPv6Addresses")]
    secondary_i_pv6_addresses: Option<Vec<super::Address>>,
    ...
    networks: Option<::std::collections::HashMap<String, super::EndpointSettings>>,
}
...
impl NetworkSettings {
    ...
    pub fn set_ports(&mut self, ports: super::PortMap) {
        self.ports = Some(ports);
    }

    pub fn with_ports(mut self, ports: super::PortMap) -> NetworkSettings {
        self.ports = Some(ports);
        self
    }

    pub fn ports(&self) -> Option<&super::PortMap> {
        self.ports.as_ref()
    }
    ...
    pub fn set_secondary_ip_addresses(&mut self, secondary_ip_addresses: Vec<super::Address>) {
        self.secondary_ip_addresses = Some(secondary_ip_addresses);
    }

    pub fn with_secondary_ip_addresses(
        mut self,
        secondary_ip_addresses: Vec<super::Address>,
    ) -> NetworkSettings {
        self.secondary_ip_addresses = Some(secondary_ip_addresses);
        self
    }

    pub fn secondary_ip_addresses(&self) -> Option<&Vec<super::Address>> {
    ...
    pub fn set_secondary_i_pv6_addresses(
        &mut self,
        secondary_i_pv6_addresses: Vec<super::Address>,
    ) {
    ...
    pub fn secondary_i_pv6_addresses(&self) -> Option<&Vec<super::Address>> {
    ...
    pub fn set_networks(
        &mut self,
        networks: ::std::collections::HashMap<String, super::EndpointSettings>,
    ) {
    ...
    pub fn networks(
        &self,
    ) -> Option<&::std::collections::HashMap<String, super::EndpointSettings>> {
