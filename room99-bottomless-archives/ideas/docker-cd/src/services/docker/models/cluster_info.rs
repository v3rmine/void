...
impl ClusterInfo {
    ...
    pub fn with_version(mut self, version: super::ObjectVersion) -> ClusterInfo {
        self.version = Some(version);
        self
    }
    ...
    pub fn with_spec(mut self, spec: super::SwarmSpec) -> ClusterInfo {
        self.spec = Some(spec);
        self
    }
    ...
    pub fn with_tls_info(mut self, tls_info: super::TlsInfo) -> ClusterInfo {
        self.tls_info = Some(tls_info);
        self
    }
    ...
    pub fn with_data_path_port(mut self, data_path_port: i32) -> ClusterInfo {
        self.data_path_port = Some(data_path_port);
        self
    }
    ...
    pub fn with_default_addr_pool(mut self, default_addr_pool: Vec<String>) -> ClusterInfo {
        self.default_addr_pool = Some(default_addr_pool);
        self
    }
    ...
    pub fn with_subnet_size(mut self, subnet_size: i32) -> ClusterInfo {
        self.subnet_size = Some(subnet_size);
        self
    }
